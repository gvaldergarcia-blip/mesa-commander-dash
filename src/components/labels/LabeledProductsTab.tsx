...
// Manipulação foi removida deste ponto — passa a ser um módulo próprio ("Nova Manipulação").
            ...
            return (
              ...
              >
                ...
                <div className="flex gap-2 pt-3 mt-3 border-t border-border">
                  ...
                  {/* Botão "Manipular" removido: use o módulo Nova Manipulação. */}
                </div>
