...
ALTER TABLE public.label_receipt_items ADD COLUMN IF NOT EXISTS weight numeric;
ALTER TABLE public.label_receipt_items ADD COLUMN IF NOT EXISTS weight_unit text;
ALTER TABLE public.label_issuances ADD COLUMN IF NOT EXISTS weight numeric;
ALTER TABLE public.label_issuances ADD COLUMN IF NOT EXISTS weight_unit text;
