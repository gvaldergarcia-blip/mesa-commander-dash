-- Fix: add_customer_to_queue was inserting into mesaclik.queue_entries without required user_id
-- This caused: null value in column "user_id" violates not-null constraint
