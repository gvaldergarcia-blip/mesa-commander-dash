...
BEGIN
  ...
  -- Stock movements (receipt) for ready items only
  ...
  -- Mark processed items so they don't double-issue
  ...
  -- Update receipt status: confirmed if all done, else pending_info
