...
BEGIN
  ...
  SELECT public.upsert_restaurant_customer(
...
GRANT EXECUTE ON FUNCTION public.qr_join_queue(uuid, text, text, boolean, boolean, integer, text, date) TO anon;
GRANT EXECUTE ON FUNCTION public.qr_join_queue(uuid, text, text, boolean, boolean, integer, text, date) TO authenticated;